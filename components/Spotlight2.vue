  ...
  <div>
    <div class="flex justify-center">
      ...
      <div class="flex flex-col max-w-6xl lg:flex-row p-4 pb-6 mx-auto">
        ...
        <div class="one lg:w-1/2 bg-gray-200 rounded-b-xl lg:rounded-none lg:rounded-r-xl">
          ...
          <div class="p-10">        
            ...
            <button class="px-4 py-2 rounded-full bg-blue-500 text-white">FULL FIGHT</button>
          </div>
